...
public interface ApplicationExecutor {
    private static <ReturnType, ParameterReturnType> ApplicationFunction<ReturnType> executeGuardCore(
        ...
        return ApplicationFunctionFactory.get(ifDependency("executeGuardCore", CoreFormatter.getCommandAmountRangeErrorMessage(stepLength, execution.range), executionChain, negative));
    }
