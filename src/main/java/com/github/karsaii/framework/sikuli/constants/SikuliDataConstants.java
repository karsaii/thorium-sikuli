...
public abstract class SikuliDataConstants {
    ...
    public static final Data<Match> NULL_MATCH = DataFactoryFunctions.getWith(SikuliCoreConstants.NULL_MATCH, false, "defaultNullMatchData", "Internal null match" + CoreFormatterConstants.END_LINE);
    public static final Data<MatchList> NULL_LIST = DataFactoryFunctions.getWith(SikuliCoreConstants.INVALID_MATCHLIST, false, "nullList", "nullList data" + CoreFormatterConstants.END_LINE);
