...
public abstract class SikuliDataConstants {
    ...
    public static final Data<MatchList> NULL_LIST = DataFactoryFunctions.getWithNameAndMessage(SikuliCoreConstants.INVALID_MATCHLIST, false, "nullList", "nullList data" + CoreFormatterConstants.END_LINE);
